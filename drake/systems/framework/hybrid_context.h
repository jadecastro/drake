...
/// determine the computations performed by a Hybrid. Specifically, a
...
/// directly. Use the accessors on Hybrid instead.
///
...
class HybridContext : public Context<T> {
 public:
  ...
  /// Constructs a HybridContext with the given @p num_subsystems, which is
  /// final: you cannot resize a HybridContext after construction.
  ...
  /// input to the entire Hybrid that allocates this Context. Aborts if the
  /// subsystem has not been added to the HybridContext.
  ///
  /// User code should not call this method. It is for use during Hybrid
  /// context allocation only.
...
///
/// In general, users should not need to interact with a HybridContext
/// directly. Use the accessors on HybridAutomaton instead.
///
/// @tparam T The mathematical type of the context, which must be a valid Eigen
///           scalar.
template <typename T>
class HybridContext : public Context<T> {
 public:
  ...
  /// Declares that a particular input port of a particular subsystem is an
  /// input to the entire HybridAutomaton that allocates this Context. Aborts
  /// if the subsystem has not been added to the HybridContext.
  ///
  /// User code should not call this method. It is for use during Hybrid
  /// context allocation only.
  void ExportInput(const PortIdentifier& id) {
