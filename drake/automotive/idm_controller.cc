...
void IdmController<T>::ImplDoCalcOutput(
  ...
  PrintAndModifyPartials(ego_pose, ego_velocity, lead_car_pose.odometry,
                         traffic_poses, idm_params, &s_dot_ego, &s_dot_lead,
                         &headway_distance);
...
void IdmController<T>::PrintAndModifyPartials(
