...
class AutomotiveSimulator {
 public:
  ...
  /// Adds a PathFollowingAgent to this simulation visualized as a Toyota Prius.
  ///
  /// @pre Start() has NOT been called.
  ///
  /// @param name The car's name, which must be unique among all cars. Otherwise
  /// a std::runtime_error will be thrown.
  ///
  /// @param curve See documentation of PathFollowingAgent::PathFollowingAgent.
  ///
  /// @param speed See documentation of PathFollowingAgent::PathFollowingAgent.
  ///
  /// @param start_time See documentation of PathFollowingAgent::PathFollowingAgent.
  ///
  /// @return The ID of the car that was just added to the simulation.
  int AddPriusPathFollowingAgent(const std::string& name,
 ...
 private:
  ...
  // Adds an LCM publisher for the given @p system.
  // @pre Start() has NOT been called.
  void AddPublisher(const PathFollowingAgent<T>& system, int vehicle_number);
  ...
  void InitializePathFollowingAgents();
  ...
  // Holds the desired initial states of each PathFollowingAgent. It is used to
  // initialize the simulation's diagram's state.
  std::map<const PathFollowingAgent<T>*, PathFollowingAgentState<T>>
